...
#image =cv2.imread('Assignment_Picture2026.png')
#cv2.imshow('Image Window Tile', image)
#cv2.waitkey(0)
...
#file = pd.read_csv("DAY03/research_and_development_survey.csv")
#print(file)
